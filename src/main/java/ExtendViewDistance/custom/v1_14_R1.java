...
public class v1_14_R1 implements Extend {
     ...
     * 創建區塊
     */
    private net.minecraft.server.v1_14_R1.Chunk createNMSChunk(World world, ProtoChunk chunk) {
        return new net.minecraft.server.v1_14_R1.Chunk(getNMSWorld(world), chunk);
    }
    ...
    private void playerSendChunk(Player player, net.minecraft.server.v1_14_R1.Chunk chunk) {
    ...
    private void playerSendChunkLightUpdate(Player player, net.minecraft.server.v1_14_R1.Chunk chunk) {
    ...
    /** 設置龍頭視野距離 */
    public void setSpigotViewDistance(World world, int viewDistance) {

        //getNMSWorld(world).spigotConfig.viewDistance = viewDistance;
    }
    ...
    public static class PlayerConnection extends net.minecraft.server.v1_14_R1.PlayerConnection {
